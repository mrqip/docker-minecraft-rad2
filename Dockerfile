...
ENV EULA_ACCEPT="true" \
    ...
    JAVA_MEMORY_MAX="64000m" \
    JAVA_MEMORY_MIN="52000m" \
    JAVA_PERM_SIZE="512m" \
    FORGE_VERSION="36.2.39" \
    RCON_ENABLED="true" \
    RCON_PASSWORD="mne2025" \
    RCON_PORT="25575" \
    DIFFICULTY="normal" \
    GAMEMODE="survival" \
    HARDCORE="false" \
    LEVEL_NAME="world" \
    LEVEL_SEED="mnemonic2025" \
    MAX_BUILD_HEIGHT="256" \
    MAX_PLAYERS="15" \
    MOTD="Mnemonic R.A.D. 2 Server" \
...
RUN apt-get update && \
    ...
    git clone https://github.com/mrqip/docker-minecraft-rad2.git && \
